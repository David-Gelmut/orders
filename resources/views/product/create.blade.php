...
@section('content')
    <form action="{{route('products.store')}}" method="post" class="max-w-sm mx-auto">
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input value="{{old('price')}}" name="price" type="text" id="price"
        ...
        <textarea name="description"  id="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('description') border-red-500 @enderror" placeholder="Описание"></textarea>
